          ...
          <div className="main-card" key={index}>
            ...
            <div className="rightDiv">
              ...
              <div className="info-sec" style={{ marginTop: "1rem" }}>
                Hello my name is tavernesia williams. Everyone calls me Neshia.
                I am 26 years old. I graduated from tougaloo college, major
                sociology/social work. I have been caring and working with
                children starting newborns to teens since an early age. I am
                currently looking for different things to do while working on
                masters degree.
              </div>
              <div
                className="info-sec"
